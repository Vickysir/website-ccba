$(function () {
  ...
  if (typeof Swiper != 'undefined') {
    ...
    var inxpartSwiper = new Swiper(".partner-wrapper", { slidesPerView: 3, simulateTouch: false, speed: 1200, spaceBetween: 25, nextButton: '.inxpart-list .index-next', prevButton: '.inxpart-list .index-prev', breakpoints: { 768: { slidesPerView: 2, spaceBetween: 20, }, 414: { spaceBetween: 10, slidesPerView: 2 } } });
